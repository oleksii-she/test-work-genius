...
const features: Feature[] = [
  {
    ...
    description: [
      'Навчитесь користуватися популярними нейромережами',
      'Опануєте основи автоматизації',
    ],
    values: {
      standard: true,
      pro: true,
              ...
              {features.map((feature) => (
                <tr key={feature.id}>
                  ...
                  <td>
                    ...
                    ) : feature.values.standard === false ? (
                      <p>-</p>
                    ) : (
                      feature.values.standard
                    )}
                  </td>
                  <td>
                    {feature.values.pro === true ? (
                      <div className={styles.checkWrapper}>
                        <svg
                          width="40"
                          height="40"
